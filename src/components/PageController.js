...
const PageController = (props) => {
    ...
    switch(props.pageIdx){
        case 0: // start 화면
            ...
            break;
        case 1: // 1번 질문
            return <QuestionBody numOfQuestions={4} style={{marginTop:'107px', width:'88%'}} onPress={props.onPress} text={'버튼'} pageIdx={props.pageIdx}/>
            break;
        default: // case 1~13
            return <QuestionBody numOfQuestions={2} onPress={props.onPress} style={{marginTop:'107px', width:'88%'}} text={'버튼'} pageIdx={props.pageIdx}/>
            break;
        case 14: // 로딩 화면
