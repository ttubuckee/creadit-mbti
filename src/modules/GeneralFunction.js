...
export const getMBTIQuestions = () => {
    const questions = [
        ...
        '우연히 너튜버에서 여러명이 함께하는 콘텐츠를 본 당신은', // Q3
        '만약 너튜브 콘텐츠를 찍어야 한다면, 당신은', // Q4
        '잠들기 직전 20분짜리 재밌는 영상을 발견했다.', // Q5
        '엉성한 퀄리티로 인기를 얻은 영상을 봤을 때, 당신은', // Q6
        '너튜브를 시작하기로 마음먹은 당신이 가장 먼저 하는 행동은', // Q7
        '너튜브를 시작하게 된 당신의 메인 콘텐츠는', // Q8
        '너튜버가 된 당신이 가장 받고 싶은 댓글은', // Q9
        '너튜브가 된 당신, 모르는 너튜버에게 합방 제의가 들어왔다.', // Q10
        '구독자와의 소통을 위해 실시간 스트리밍을 시작해보려고 한다, 당신은', // Q11
        '생각보다 빨리 구독자 1,000명을 얻게 되었습니다. 이때 당신의 기분은', // Q12
        '당신의 너튜브 채널에 장문의 악플이 달렸습니다. 당신의 반응은', // Q13
    ];
    return questions;
}
